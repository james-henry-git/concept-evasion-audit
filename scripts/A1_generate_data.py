#!/usr/bin/env python3
"""
A1: Save concept datasets to disk.
"""
import argparse
import sys
...
parser.add_argument("--concepts", nargs="+", default=None, help="Subset of concepts (default: all)")
parser.add_argument("--seed", type=int, default=42)
args = parser.parse_args()

concepts = args.concepts or ALL_CONCEPTS
out_path = RESULTS_DIR / "concept_data.json"
save_concept_data(out_path, concepts=concepts, seed=args.seed)
